...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { birthdate: @profesor.birthdate, lastname: @profesor.lastname, mail: @profesor.mail, name: @profesor.name } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { birthdate: @profesor.birthdate, lastname: @profesor.lastname, mail: @profesor.mail, name: @profesor.name } }
