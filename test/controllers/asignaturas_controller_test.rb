...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { codigo: @asignatura.codigo, creditos: @asignatura.creditos, descripcion: @asignatura.descripcion, nombre: @asignatura.nombre, prerresquisitos: @asignatura.prerresquisitos, profesor: @asignatura.profesor } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { codigo: @asignatura.codigo, creditos: @asignatura.creditos, descripcion: @asignatura.descripcion, nombre: @asignatura.nombre, prerresquisitos: @asignatura.prerresquisitos, profesor: @asignatura.profesor } }
