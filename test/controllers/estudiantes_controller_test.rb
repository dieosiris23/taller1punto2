...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { birthday: @estudiante.birthday, creditos_inscritos: @estudiante.creditos_inscritos, mail: @estudiante.mail, nombre: @estudiante.nombre, papa: @estudiante.papa } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { birthday: @estudiante.birthday, creditos_inscritos: @estudiante.creditos_inscritos, mail: @estudiante.mail, nombre: @estudiante.nombre, papa: @estudiante.papa } }
